...
function equipmentSection(){
  ...
  if(!character.items.length){group.content.append(card('Equipment was not imported','Not loaded','Re-import this public D&D Beyond character from More → Import. Altered will preserve equipped weapons and supported numeric item effects without applying imported totals twice.','warning').node);return group.section;}
