...
Extract `Altered-Desktop-Mac-v0.27.8.zip`, keep all included files together, then open `Altered-v0.27.8.html` in a current browser. The package includes Ferocitus, the rules engine, Help, all six built-in form images, the no-JSON customization tools, and the lazy-loaded PDF/OCR readers.
