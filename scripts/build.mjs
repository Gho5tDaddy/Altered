...
const downloadAssets=Object.fromEntries(await Promise.all([
  ['Altered-Desktop-Mac-v0.29.15.zip','application/zip'],
  ['Altered-Windows-Setup-v0.29.15.exe','application/octet-stream'],
].map(async([name,type])=>[
  `/downloads/${name}`,
...
await readFile(path.join(root,'public','downloads','Altered-Android-v0.29.15.apk'));
